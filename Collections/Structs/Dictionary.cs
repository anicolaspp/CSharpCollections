...
namespace Nikos.Collections
{
    ...
    {
        private readonly AVL_Tree<Pair<TKey, TValue>> m_Collection;
        ...
        public Dictionary()
        {
            m_Collection = new AVL_Tree<Pair<TKey, TValue>>();
        }
        ...
        {
            return m_Collection.Select(pair => new KeyValuePair<TKey, TValue>(pair.Key, pair.Value)).GetEnumerator();
        }
        ...
        public void CopyTo(KeyValuePair<TKey, TValue>[] array, int arrayIndex)
        {
            ...
            var source = (from pair in m_Collection
        ...
        public bool ContainsKey(TKey key)
        {
            ...
            return m_Collection.Contains(new Pair<TKey, TValue> { Key = key }, out temp);
        }
        ...
        public void Add(TKey key, TValue value)
        {
            ...
            m_Collection.Add(new Pair<TKey, TValue> { Key = key, Value = value });
        }
        ...
        {
            AVL_Node<Pair<TKey, TValue>> temp;
            bool result = m_Collection.Contains(new Pair<TKey, TValue> { Key = key }, out temp);
            if (result)
                m_Collection.Remove(new Pair<TKey, TValue> { Key = key });
        ...
        public TValue this[TKey key]
        {
            ...
            set
            {
                ...
                if (m_Collection.Contains(new Pair<TKey, TValue>{Key = key}, out node))
                {
        ...
        {
            get { return m_Collection.Select(x => x.Key).ToArray(); }
        }
        ...
        public ICollection<TValue> Values
        {
            get
            {
                return (m_Collection.Where(pair => pair != null).Select(pair => pair.Value)).ToArray();
            }
        }
